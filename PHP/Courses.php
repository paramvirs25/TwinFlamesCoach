...
class Courses {
    ...
    public static function getAllCourses() {
        $courses = array(
            ...
            "certified_coach" => new Courses("Twin Flames Coach program", "certified_coach", 10, "Twin Flames Coach 1"),
            ...
            "apprentice_basic_iw" => new Courses("Apprentice - Basic IW", "apprentice_basic_iw", 10, "Apprenticeship Basic IW"),
